...
import com.pasyappagent.pasy.modul.home.transaction.*;
...
public class FeedTrxFragment  extends Fragment implements com.pasyappagent.pasy.modul.CommonInterface, TransactionView, RecyFeedTrxAdapter.OnListClicked, ListActionLoadMore {
    private RecyclerView listView;
    private RecyFeedTrxAdapter mAdapter;
    private CustomProgressBar progressBar = new CustomProgressBar();
    private com.pasyappagent.pasy.modul.home.transaction.TransactionPresenter mPresenter;
