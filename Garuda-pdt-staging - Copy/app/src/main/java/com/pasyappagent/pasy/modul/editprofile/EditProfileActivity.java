...
//    }
    ...
    protected void setContentViewOnChild() {
        ...
        chatCSBtn = findViewById(R.id.chat_cs);
        ...
        chatCSBtn = (Button) findViewById(R.id.chat_cs);
        chatCSBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
