...
public class RecyFeedTrxAdapter extends RecyclerView.Adapter<RecyFeedTrxAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RecyFeedTrxAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_feed_trx, parent, false));
    }

    @Override
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        GFeedTrx feed = feedList.get(position);
